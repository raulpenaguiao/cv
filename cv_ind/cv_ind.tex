...
\moveleft.5\hoffset\centerline{{\Huge\bf RAUL PENAGUIAO PhD.}} % Your name at the top
\vspace{1.5mm}
...
Software engineer, UI developer and Data analyst - \href{https://haeusler.com/}{Link to webpage}

{\sl Max Planck Institute}, Leipzig, Germany. (September 2022 - September 2023)\\
PostDoc researcher at the \href{https://www.mpg.de/en}{Max Planck society}\\
...
{\small Teaching assistant and doctoral student at University of Z\"urich (2016 - 2020)}\\
...
PhD thesis Advisor: Prof. Dr. Valentin F\'eray

Masters of Science in Mathematics - Degree (MSc) in Pure Mathematics \\
{\sl ETH Z\"urich}, Switzerland (September 2014 - September 2016)\\
\textit{The Chromatic Symmetric Function on Random Graphs} \\%Grade: 5.64/6
Master thesis advisors: Prof. Dr. Valentin F\'eray and Prof. Dr. Angelika Steger
...
\begin{itemize}
\item General-purpose: C++, C\#, julia and python
...
\section{Organization of conferences and leadership}

Mentoring of three projects with junior students and PhDs
\vspace{-0.2cm}

Organizer of the "NMath workshop for computer science and algorithms in 2021"
\vspace{-0.2cm}

Organizer of the "Student workshop for permutation patterns in 2019" : \href{https://sites.google.com/view/permutation-patterns-2019/pre-conference-workshop}{Webpage}.
\vspace{-0.2cm}
...
Organizer of "Mathematics, Statistics and Computation Journeys" (JMEC 1), main organizer of the Math exposition in 2014 : \href{http://nmath.tecnico.ulisboa.pt/jm/}{Webpage}
...
\begin{itemize}
\item Coded a browser password manager and a browser clicker game \href{https://passworded.netlify.app/}{here} and \href{https://user.math.uzh.ch/penaguiao/Christmas_Game/}{here}.
\item Took part of the scouting movement since five years old, still a volunteer
\item Enjoy regular hiking and camping (I have camped above 3200m altitude!)
\item Participate regularly on online programming competitions ($>390$ problems solved in Project Euler!)
\end{itemize}
