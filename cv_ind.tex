...
\begin{itemize}
\item I created a password manager! See \href{https://passworded.netlify.app/}{here}.
\item I created a clicker game! See \href{https://user.math.uzh.ch/penaguiao/Christmas_Game/}{here}.
...
\item Online programming competitions ($>300$ problems solved in Project Euler!)
\end{itemize}
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip % Horizontal line after name; adjust line thickness by changing the '1pt'
